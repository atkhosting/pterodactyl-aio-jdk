...
#
# Copyright (c) 2026 ATK Hosting. All rights reserved.
#
# Source-Available License: Inspection & audit viewing only.
# Running, copying, modifying, hosting, or distributing this code or its
# derivatives by unauthorized third parties is strictly prohibited.
#
...
# Print Java version
printf "${LIGHT_BLUE}container@atkhosting-java-info~ ${RESET_COLOR}java -version\n"
...
printf "${GREEN}container@atkhosting~ ${RESET_COLOR}%s\n" "$PARSED"
